...
DATA_URL = (
r"/home/rhyme/Desktop/Project/Motor_Vehicle_Collisions_-_Crashes.csv"
)

st.title("Motor Vehicle Collision in New York city")
st.markdown("This application is a streamlit dashboard to analyse motor vehicle collision🏆")
...
st.header("Where are the most people injuring in Newyork city?")
...
st.markdown("Vehicle collisions occure between %i:00 and %i:00"% (hour, (hour+1)%24))
